...
def create_dummy_caregivers():
    ...
    caregivers_data = [
        ...
        {
            "email": "apollo.bangalore@mediai.com",
            "password": "password123",
            "full_name": "Dr. Admin Apollo",
            "phone": "+91-9876543212",
            "business_name": "Apollo Hospital Bangalore",
            ...
            "business_country": "India",
            "business_description": "Leading multi-specialty hospital with 24/7 emergency services"
        },
        {
